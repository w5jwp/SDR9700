...
bundle:
	...
	./resources/scripts/deploy-macos.sh $(BUILD_DIR)/bin/SDR9700.app

sign:
	./resources/scripts/sign-macos.sh $(BUILD_DIR)/bin/SDR9700.app

dmg: bundle
	./resources/scripts/package-macos.sh $(BUILD_DIR)/bin/SDR9700.app $(BUILD_DIR)/package
...
notarize:
	...
	./resources/scripts/notarize-macos.sh "$(DMG)"
