...
constexpr int kMemoryTableColumnCount = 10;
...
constexpr int kMemoryToneFrequencyColumn = 6;
constexpr int kMemoryFilterColumn = 7;
constexpr int kMemoryScanColumn = 8;
constexpr int kMemoryIdColumn = 9;
constexpr QSize kMemoryWindowSize(980, 540);
...
constexpr int kMemoryToneColumnWidth = 80;
constexpr int kMemoryToneFrequencyColumnWidth = 130;
constexpr int kMemoryScanColumnWidth = 116;
