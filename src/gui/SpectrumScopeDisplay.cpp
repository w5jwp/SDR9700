...
SpectrumScopeDisplay::SpectrumScopeDisplay(QWidget* parent) : QWidget(parent)
{
    ...
    m_panScrollBar->setStyleSheet(QStringLiteral(
        ...
        "QScrollBar::handle:horizontal { background: #3e5d75; border: 1px solid #8eabc1; border-radius: 4px; "
        "min-width: 34px; margin: 2px 1px; }"
        "QScrollBar::handle:horizontal:hover { background: #52728c; border-color: #a9bfd0; }"
        "QScrollBar::handle:horizontal:pressed { background: #63839c; border-color: #d1dce5; }"
